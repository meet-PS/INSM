...
#
# Adapted by Pranjal Sharma (psharma9@ncsu.edu), Prithvi Sharan (psharan@ncsu.edu), Sai Jayesh Bondu (sjbondu@ncsu.edu), Luv Khurana (lkhuran@ncsu.edu), for CSC573 '18 project, from scripts found in
...
class ExerciseRunner:
    ...
    def __init__(self, topo_file, log_dir, pcap_dir,
        ...
        """ Initializes some attributes and reads the topology json. Does not
            actually run INSM. Use run_insm() for that.
